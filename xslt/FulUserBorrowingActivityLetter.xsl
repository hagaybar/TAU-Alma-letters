											...
											<td>
												<table cellpadding="5" class="listing">
													...
													<tr>
														...
														<th>@@due_date@@</th>
														<th>@@fine@@</th>
														<!-- insert library email column (template in footer.xsl) -->
														<xsl:call-template name="insert_email_column" />
													...
													<xsl:for-each select="item_loans/overdue_and_lost_loan_notification_display/item_loan">
														<tr>
															...
															<!-- insert library email (template in footer.xsl) -->
															<xsl:call-template name="insert_lib_email" />
														</tr>
													</xsl:for-each>
												</table>
											</td>
